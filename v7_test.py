...
car_pos_lanes = [[-4, 0], [-3, 0], [-5, 0]]
car_pos_fars = [40, 20, 42]
car_speeds = [100, 130, 100]
...
num_of_lane_change = [5, 0, 0]
num_of_speed_change = [0, 0, 0]

lane_change_times = [[0, 1, 2, 3, 4], [], []]
speed_change_times = [[], [], []]

lane_change_values = [[1, 1, 1, 1, 1], [], []]
changed_lanes = [[[-4, 0], [-4, 0], [-4, 0], [-4, 0], [-5, 0]], [], []]
speed_change_values = [[], [], []]
changed_speeds = [[], [], []]
